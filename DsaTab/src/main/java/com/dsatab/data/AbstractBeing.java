...
public abstract class AbstractBeing {
    ...
    private Map<String, Talent> talentByType;
    ...
    public AbstractBeing() {
        ...
        this.talentByType = new TreeMap<String, Talent>();
    }
    ...
    public Talent getTalent(TalentType talentName) {
        return talentByType.get(talentName.xmlName());
    }
    ...
    public void addTalent(Talent talent, boolean visible) {
        ...
        if (visible) {
            TalentGroup tg = talentGroups.get(talent.getGroupType());
            if (tg != null) {
                tg.getTalents().add(talent);
            } else {
                tg = new TalentGroup(talent.getGroupType());
                tg.getTalents().add(talent);
                talentGroups.put(talent.getGroupType(), tg);
            }
        }

        talentByType.put(talent.getName(), talent);
